defmodule Obelisk.Config do
  ...
  defp _load_config({:error, _}), do: {:ok, Obelisk.Template.config} |> _load_config
  defp _load_config({:ok, content}), do: Obelisk.YAML.convert(%{}, hd(:yamerl_constr.string(content)))
end
